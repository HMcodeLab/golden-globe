...
(() => {
  ...
  var i = function t(e, i) {
    ...
    if (e && i && "object" == typeof e && "object" == typeof i) {
      ...
      if (Array.isArray(e)) {
        ...
        for (s = r; 0 != s--; ) if (!t(e[s], i[s])) return !1;
        return !0;
      }
      ...
      if ((r = (n = Object.keys(e)).length) !== Object.keys(i).length)
        return !1;
      for (s = r; 0 != s--; )
  ...
  class n {
    constructor({
      ...
      if (
        ...
        if (!i(this.options, n.instance.options))
          throw new Error(
  ...
  const o = [
    { featureType: "landscape", stylers: [{ hue: "#00dd00" }] },
    { featureType: "road", stylers: [{ hue: "#dd0000" }] },
    { featureType: "water", stylers: [{ hue: "#000040" }] },
    { featureType: "poi.park", stylers: [{ visibility: "off" }] },
    { featureType: "road.arterial", stylers: [{ hue: "#ffff00" }] },
  ...
  const a = function () {
    var t = new n({
      ...
      r = { lat: 40.74881584652125, lng: -73.98561648634562 };
    t.load().then(function () {
      ...
      new google.maps.Marker({ position: r, map: t, icon: "./svg/marker.svg" });
    });
  };
